  ...
  return (
    <div>
      ...
      <p>
        ...
        has two possible states, alive or dead. This game has been used to
        simulate many real life scenarios across Physics, Biology, Economics,
        and Philosophy. There are a number of patter that continually reappear
        over time including the Block, Boat, Blinker, Toad, Glider, LWSS, and
        the Pulsar.
      </p>
